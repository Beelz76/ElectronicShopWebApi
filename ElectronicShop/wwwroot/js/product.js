...
async function getProductsInfo() {
    try {
        ...
        if (response.ok) {
            ...
            productContainer.innerHTML = '<h1 class="text-center" style="margin-top: 5%">TOBAPbl</h1><br><br>';
                ...
                card.innerHTML = `
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Manufacturer: ${product.manufacturers}</p>
                            ...
                            <button class="btn btn-primary" value="${product.productUid}" id="createOrder-${product.productUid}" onClick="createOrder(event)">Add to cart</button>
                        </div>
                    </div>`;
